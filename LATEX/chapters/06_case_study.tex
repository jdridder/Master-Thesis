...
Especially with regard to \emph{load flexible} processes using renewable energy sources, dynamic control such as MPC can enable optimal operation \cite{fischer2021}. For example, the energy supply can be closely tied to weather conditions or the feed composition may fluctuate due to
...
MPC performance evaluation (\ref{MPC-Performance-and-Robustness}). 
...
diffusive mass transport in direction $k$. The source or sink term $\sigma_\alpha$ allows to consider chemical reactions.
