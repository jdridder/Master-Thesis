...
This may deteriorate the quantile prediction in contrast to the expected value NARX relying
...
When the fully physics constrained NARX architecture is sumlated forward in time, a small improvement can be
noticed (fig.~\ref{results:fig:pc-concentration-sim}).
