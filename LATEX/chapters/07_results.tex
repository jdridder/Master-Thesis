...
neurons. Mentioned frameworks are simulated forward in \SI{512} time steps for 100 independent input trajectories.
...
widths (green) are supplied via boxplots (fig.~\ref{results:fig:vanilla-coverage-width}).
