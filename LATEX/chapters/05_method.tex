...
The reactor is assumed to be already existend with a fixed design to clearly separate the model derivation
...
To ensure thermal stability, the additional temperature
profile derivation is mandatory. 
...
\begin{equation}
    ...
    \begin{gathered}
        ...
        + (1 - \epsilon) \frac{\mathrm{R} T_*}{p x_*} \sum^j \nu_{\alpha,j} r_j(\chi_\alpha, T') \\
