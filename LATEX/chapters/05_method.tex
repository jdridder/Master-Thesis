...
and $T_{\text{ads},j}$ the adsorption temperature.
...
from an optimal design task. Using the component balace in local form (eq.~\ref{case:eq: component balance in local form}), a PDE can be derived that
